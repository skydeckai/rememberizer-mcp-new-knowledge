...
Please note that `rememberizer-mcp-new-knowledge` is currently in development and the functionality may be subject to change.
...
If you have the MseeP AI Helper app installed, you can search for "Rememberizer" and install the rememberizer-mcp-new-knowledge.
...
"mcpServers": {
  "rememberizer": {
      "command": "uvx",
      "args": ["rememberizer-mcp-new-knowledge"]
    }
}
```
